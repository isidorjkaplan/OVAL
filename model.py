...
class Autoencoder(nn.Module):
    def __init__(self, image_dim, n_channels=3, save_path=None, conv_settings=[ConvSettings(6, 1, 3), ConvSettings(8, 1, 3), ConvSettings(9, 2, 3), ConvSettings(10, 2, 4), ConvSettings(10, 2, 5),ConvSettings(10, 2, 6), ConvSettings(10, 1, 3), ConvSettings(10, 2, 5)], linear_layers=None):
        super().__init__()
