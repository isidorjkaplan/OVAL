...
| Task Name  |  Notes | Assigned | ETA / Time  | Due  | Completed  | 
|---|---|---|---|---|---|
| Project Idea  |   | Isidor  | 3  |  Jan 27 | Jan 27 |
| Architecture Design  |   | Isidor  | 3  |  Jan 27 | Jan 27 |
| Formal Preposal  |   | Adam  | 8 |  Feb 3 | Feb 3 |
| Online Code |   | Isidor  | 8  |  Feb 12 | Feb 1 |
| Offline Code |   | Isidor  | 6  |  Feb 12 | Feb 9 |
| Model Video Evaluator |   | Isidor  | 2  |  Feb 12 | Feb 9 |
| Model V1 |   | Isidor  | 3  |  Feb 12 | Feb 9 |
| Model V2 |   | Ryan  | 3  |  Feb 12 | - |
| Color Spaces (Model Out) | What should model try to predict. Will help with the loss function and black/white problem. Will need to simply add a function that we call on the input image before passing into the loss with the model. Also will need to adjust the video generators to convert back to RGB before saving. This could potentially be internal to the model, it is a design desicion. | -  | 1  |  - | - |
